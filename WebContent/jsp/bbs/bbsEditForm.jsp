...
<!-------------------------------------------컨텐츠 부분-------------------------------------------------------------- --> 
    ...
    <div class="row">
        ...
        <!-- 새로운 글 쓰기  -->    
 		...
 		<div class=" col-lg-12 ">
 		<center>
			<h1><s:property value="#session.signUser.name"/>님의 글쓰기 입니다.</h1>    
			<form id="bbsform"  action="bbsEdit.action?boardnum=<s:property value="board.boardnum"/>" method="post" enctype="multipart/form-data">
			...
			<tr>
				...
				<td>
					<input type="text" name="board.title" value="<s:property value="board.title"/>" id="title" style="width:100%;"/>
				</td>
			</tr>
			<tr>
				<td class="info">내용</td> 
				<td>
					<textarea name="board.content" id="content">${board.content}</textarea>
			...
			<tr>
				<td colspan="2" align=center>
    					  <div class="button-row">
						    <a href="javascript:checkform()" class="button square blue effect-2">수정완료</a> 
